...
class bidi_models:
	...
	def mdl(self,V_i, v_t = False):
			...
			interp_model = dataset_to_2D([self.ny,self.nx], self.n_annulus, self.rings_pos, self.r_n, self.XY_mesh, self.kinmdl_dataset, self.vmode, self.v_center, None, None, V_i = V_i, nmodls=1)
